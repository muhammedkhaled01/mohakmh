        ...
        <tbody>
            @forelse ($transactions as $transaction)
                <tr>
                    ...
                    <td>{{ $transaction->bank_transferred }}</td>
                    <td>{{ $transaction->status }}</td>
                    <td>
                        <div class="row justify-content-around">
                            <form action="{{ route('delete-local-transactions', [$transaction->id]) }}"
                                method="post">
                                @csrf
                            ...
                            <a href="{{route("show-local-transactions",$transaction->id)}}" class="btn btn-sm btn-primary">
                                <i class="fa fa-pen"></i>
                            </a>
                        </div>
